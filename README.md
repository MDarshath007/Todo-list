...
As part of my front-end development journey, I built a To-Do List web application using HTML, CSS, and JavaScript.
...
<ul>
 ...
 <li>✔ Save tasks using LocalStorage (data persists after refresh)</li>
